...
public class HandoverTransport extends MultiLocatorTransport implements TSDListener, AcceptanceDelegate, PeerManager {
    PeerId pid;
    String name;
    List<TSD> tsds;
...
//    }
    ...
    public HandoverTransport(PeerId pid, String name) {
        super(pid, name);
        this.pid = pid;
        this.name = name;
        this.tsds = new ArrayList<TSD>();
